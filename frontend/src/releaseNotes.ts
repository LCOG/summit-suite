...
export const releases = [
  {
    ...
    changes: [
      {
        type: 'improved',
        description: 'Minor improvements to CC app.'
      },
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'improved',
        description: 'Minor improvements to phish templates.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'improved',
        description: 'Add suspicious links to synthetic phishes.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'improved',
        description: 'Responsibilities app siloed by organization'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'new',
        description: 'Organization tab now available to all users.'
      },
      {
        type: 'improved',
        description: 'Phish reporting workflow enhancements.'
      },
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      ...
      {
        type: 'improved',
        description: 'Backend improvements to performance reviews.'
      },
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      ...
      {
        type: 'improved',
        description: 'Add content to marketing page.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'improved',
        description: 'Workflow Process versioning now supported.'
      },
      {
        type: 'improved',
        description: 'Minor improvements to Performance Reviews app.'
  ...
  },
  {
    ...
    changes: [
      {
        type: 'improved',
        description: 'Minor improvements to Performance Review app.'
      }
    ]
  },
  {
    ...
    changes: [
      {
        type: 'new',
        description: 'New Phishing management app.'
      },
      {
        type: 'improved',
        description: 'Minor improvements to Performance Review app.'
  ...
  },
  {
    ...
    changes: [
      {
        type: 'improved',
        description: 'Many improvements to Performance Reviews module.'
      },
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'improved',
        description: 'Minor improvements to the app.'
      },
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'improved',
        description: 'Various under-the-hood improvements.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'improved',
        description: 'Performance improvements to the CC app.'
      },
      {
        type: 'fix',
        description: 'Fix a bug on the employee transition form.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'improved',
        description: 'Update backed libraries.'
      },
      {
        type: 'improved',
